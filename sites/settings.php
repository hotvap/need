 ...
 *
 */
$drupal_hash_salt = 'DtKgRbC7EkryldZ6LeiIZsAFaShdlYShuM5c1h08cwE';
...
$conf['filecache_directory'] = 'mcache/filecache-' . substr(conf_path(), 6);
...
$conf['awssdk2_access_key'] = 'AKIAJZBFGP6M7K354GTQ';
$conf['awssdk2_secret_key'] = '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';

##$conf['advagg_root_dir_prefix'] = 's3://';

# $conf['advagg_skip_404_check'] = TRUE;
# $conf['404_fast_paths_exclude'] = '/\/(?:styles|advagg_(cs|j)s)\//';
# $conf['advagg_fast_filesystem'] = FALSE;
