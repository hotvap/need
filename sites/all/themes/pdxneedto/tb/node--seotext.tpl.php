...
if( isset($node->field_pnid['und'][0]['value']) and strlen($node->field_pnid['und'][0]['value']) ){
    if( mb_substr($node->field_pnid['und'][0]['value'],0,1)=='/' ){
        $node->field_pnid['und'][0]['value']=mb_substr($node->field_pnid['und'][0]['value'],1);
    }
    drupal_goto($node->field_pnid['und'][0]['value'], array(), 301);
}else{
