...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="node-container">
    ...
    <div class="nodecontent"<?php print $content_attributes; ?>>
      ...
      <?php
if( arg(0)=='node' and is_numeric(arg(1)) and arg(1)==$node->nid ){
      hide($content['webform']);
      print render($content);

      echo '<div id="webformis"></div>';
    ...
    if(!$pdxshowhelp2){
        ...
        echo '<li><a href="/node/'.$node->nid.'/webform/emails/1">Изменить e-mail, на который будет отправлено письмо</a></li>';
        echo '<li><a href="/node/'.$node->nid.'/webform">Компоненты формы</a></li>';
        echo '<li><a href="/node/'.$node->nid.'/webform/configure">Настройки формы</a></li>';
